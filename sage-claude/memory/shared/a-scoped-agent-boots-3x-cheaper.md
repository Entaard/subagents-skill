...
- Qualifier: the ratio travels; the absolute floor does not, because it includes whatever files that machine always loads — read the figure from the local band KIs.
