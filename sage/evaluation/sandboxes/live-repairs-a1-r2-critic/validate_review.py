...
save(HERE / "review-validation.json",dict(public_cli=result,status_transition_validated_in_memory=True,
     status_bytes_unchanged=True,projected_gate=projected["modules"]["live_repairs"]["gate"],review_sha256=sha(review_path)))
print("Review and next STATUS transition validate; actual STATUS unchanged.")
